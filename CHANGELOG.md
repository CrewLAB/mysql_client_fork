...
- **Fork release** — This package is published as `mysql_client_fork` from [CrewLAB/mysql_client_fork](https://github.com/CrewLAB/mysql_client_fork).
- Connection state management and operation locks for safer concurrent use.
- Exponential backoff retry logic for resilient connections.
- Pool connection disposal fixes.
- Comprehensive test suite (844+ lines of tests).
