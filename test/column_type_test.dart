...
void main() {
  test("testing decimal type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<bool>('10.00'), throwsException);

    expect(() => sqlType.convertStringValueToProvidedType<int>('10.00'), throwsException);

    expect(() => sqlType.convertStringValueToProvidedType<double>('10.00'), throwsException);

    expect(() => sqlType.convertStringValueToProvidedType<num>('10.00'), throwsException);
  });
  ...
  test("testing tiny type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<bool>('1', 2), throwsException);
  });
  ...
  test("testing short type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<bool>('1'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('0'), throwsException);
  });
  ...
  test("testing float type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<int>('1.0'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('1.0'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('0.0'), throwsException);
  });
  ...
  test("testing timestamp type", () {
    ...
    final dynamic result = sqlType.convertStringValueToProvidedType<String>('123451234');
    expect(result, '123451234');

    expect(() => sqlType.convertStringValueToProvidedType<int>('123451234'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('123451234'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('123451234'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('123451234'), throwsException);
  });

  test("testing date type", () {
    final sqlType = MySQLColumnType.create(mysqlColumnTypeDate);

    final dynamic result = sqlType.convertStringValueToProvidedType<String>('2022-01-02');
    expect(result, '2022-01-02');

    expect(() => sqlType.convertStringValueToProvidedType<int>('2022-01-02'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('2022-01-02'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('2022-01-02'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('2022-01-02'), throwsException);
  });

  test("testing time type", () {
    final sqlType = MySQLColumnType.create(mysqlColumnTypeDate);

    final dynamic result = sqlType.convertStringValueToProvidedType<String>('02:00:34');
    expect(result, '02:00:34');

    expect(() => sqlType.convertStringValueToProvidedType<int>('02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('02:00:34'), throwsException);
  });

  test("testing datetime type", () {
    final sqlType = MySQLColumnType.create(mysqlColumnTypeDate);

    final dynamic result = sqlType.convertStringValueToProvidedType<String>('2022-01-05 02:00:34');
    expect(result, '2022-01-05 02:00:34');

    final dynamic resultAsDate = sqlType.convertStringValueToProvidedType<DateTime>('2022-01-05 02:00:34');
    expect(resultAsDate, DateTime.parse('2022-01-05 02:00:34'));

    expect(() => sqlType.convertStringValueToProvidedType<int>('2022-01-05 02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('2022-01-05 02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('2022-01-05 02:00:34'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('2022-01-05 02:00:34'), throwsException);
  });
  ...
  test("testing year type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<double>('2022'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('2022'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('2022'), throwsException);
  });
  ...
  test("testing varchar type", () {
    ...
    expect(() => sqlType.convertStringValueToProvidedType<int>('2022'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('2022'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('2022'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('2022'), throwsException);
  });
  ...
  test("testing enum type", () {
    ...
    final dynamic result = sqlType.convertStringValueToProvidedType<String>('process');
    expect(result, 'process');

    expect(() => sqlType.convertStringValueToProvidedType<int>('process'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<double>('process'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<num>('process'), throwsException);
    expect(() => sqlType.convertStringValueToProvidedType<bool>('process'), throwsException);
  });
