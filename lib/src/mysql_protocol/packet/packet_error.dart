...
class MySQLPacketError extends MySQLPacketPayload {
  ...
  MySQLPacketError({required this.header, required this.errorCode, required this.errorMessage});
  ...
  factory MySQLPacketError.decode(Uint8List buffer) {
    ...
    return MySQLPacketError(header: header, errorCode: errorCode, errorMessage: errorMessage);
  }
