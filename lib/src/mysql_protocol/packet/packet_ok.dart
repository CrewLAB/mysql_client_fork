...
class MySQLPacketOK extends MySQLPacketPayload {
  ...
  MySQLPacketOK({required this.header, required this.affectedRows, required this.lastInsertID});
  ...
  factory MySQLPacketOK.decode(Uint8List buffer) {
    ...
    return MySQLPacketOK(header: header, affectedRows: affectedRows.item1, lastInsertID: lastInsertID.item1);
  }
