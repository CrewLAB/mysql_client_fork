...
**This is a fork of [zim32/mysql.dart](https://github.com/zim32/mysql.dart)** (published as `mysql_client` on pub.dev) with substantial enhancements. The original package has not been updated in 3+ years.

#### Improvements in this fork

- **Connection state management and operation locks** — Safer concurrent use and clearer connection lifecycle.
- **Exponential backoff retry logic** — More resilient connections under load or transient failures.
- **Pool connection disposal fixes** — Correct cleanup and reuse of pooled connections.
- **Comprehensive test suite** — 844+ lines of tests for connection, protocol, and pool behavior.
